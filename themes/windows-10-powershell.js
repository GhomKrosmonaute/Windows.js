...
Window.addTheme('Windows 10 PowerShell', 'microsoft', {
    window: {
        boxShadow: "rgba(0, 0, 0, 0.4) 0px 20px 70px",
    ...
    fullscreen: `<svg style="height:38%;" aria-hidden="true" focusable="false" data-prefix="far" data-icon="square-full" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-square-full fa-w-16 fa-5x"><path fill="currentColor" d="M0 0v512h512V0H0zm464 464H48V48h416v416z" class=""></path></svg>`,
    minimize: `<svg style="height:39%;margin-bottom:18%" aria-hidden="true" focusable="false" data-prefix="fal" data-icon="window-minimize" role="img" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 512 512" class="svg-inline--fa fa-window-minimize fa-w-16 fa-3x"><path fill="currentColor" d="M496 480H16c-8.8 0-16-7.2-16-16s7.2-16 16-16h480c8.8 0 16 7.2 16 16s-7.2 16-16 16z" class=""></path></svg>`
})